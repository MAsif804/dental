    ...
    <nav className="fixed top-0 left-0 right-0 z-50 flex w-full mx-auto items-center justify-center mt-[28px] py-2 sm:py-[7px] px-4 sm:px-6 md:px-10 lg:px-[40px] xl:px-[77px] bg-[#000]">
      <div className="flex w-full items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-[10px] w-auto sm:w-[192px]">
          <img src="/dental-logo.png" alt="Dental Logo" className="absolute w-[28px] sm:w-[200px] h-[35px] sm:h-[200px] aspect-square" />
        </div>
        ...
        <div className="hidden md:flex items-center gap-4 lg:gap-[30px] xl:gap-[42px]">
          <ul className="flex py-4 sm:py-[20px] items-center gap-4 lg:gap-[20px] xl:gap-[30px]">
            <li className="cursor-pointer uppercase font-Poppins text-base sm:text-lg lg:text-[18px] xl:text-[20px] font-normal">
              <Link
                to="/"
        ...
        <button className="relative flex h-10 sm:h-[42px] border-[3px] border-white rounded-[20px] bg-transparent px-[18px]  py-[12px] items-center gap-3 sm:gap-[12px]">
          <span className="text-white font-Langar text-base sm:text-lg lg:text-[18px] xl:text-[20px] font-semibold">
            Book Now
          </span>
          <ArrowRightIcon className="w-5 h-5 stroke-[3px] text-white" />
        </button>
      </div>
